import {
  IEditorService, StandaloneServices,
  createInstance
...
// Add event listener for the transformed panel button
// document.querySelector('#showTransformedPanel')!.addEventListener('click', async () => {
//   await StandaloneServices.get(IEditorService).executeCommand('showTransformedPanel')
// })
