...
export interface DAnyField {
  ...
  /**@description CASTSSS	@example castas()*/
  castas(): DVarcharField;
}
...
export interface DGlobalField {
  ...
  count(): DNumericField;
  /**@description CASTSSS	@example castas()*/
  castas(vtype: DAnyable): DVarcharField;
}
...
export interface CGlobal {
  ...
  /**@description CASTSSS	@example castas()*/
  castas(vtype: DAnyable): Partial<CVarchar>;
}
...
export const DTypes = [
  ...
  {
    "type_name": "timestamp_s",
    "type_size": 8,
    "logical_type": "TIMESTAMP_S",
    "type_category": "DATETIME",
  },
  {
    "type_name": "timestamp_us",
    "type_size": 8,
    "logical_type": "TIMESTAMP",
    "type_category": "DATETIME",
  },
  {
    "type_name": "timetz",
    "type_size": 8,
    "logical_type": "TIME WITH TIME ZONE",
    "type_category": "DATETIME",
  },
  {
    "type_name": "tinyint",
