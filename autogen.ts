...
export interface DDateField extends DAnyField {
  ...
  /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - [DDate] - - - - - - -  */
  /**                                                            @default: add(col0:DATE, col1:TIME WITH TIME ZONE | TIME | INTERVAL | INTEGER) -> TIMESTAMP WITH TIME ZONE*/
  ...
  /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - [DDate] - - - - - - -  */
  /**                                                            @default: subtract(col0:DATE, col1:INTERVAL | INTEGER) -> TIMESTAMP*/
...
export interface DArrayField<T = DAnyField> extends Omit<Array<T>, "map" | "filter" | "reduce"> {
  ...
  /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - [DArray] - - - - - - -  */
  /**                                                            @description: Get subfield (equivalent to extract)	@example: date_part('minute', TIMESTAMP '1992-09-20 20:38:40')	@default: date_part(ts:VARCHAR[], col1:TIMESTAMP WITH TIME ZONE | DATE | INTERVAL | TIME | TIMESTAMP | TIME WITH TIME ZONE) -> STRUCT()*/
  date_part(col1: DAnyable | DDateable): DStructField;
  /**                                                            @description: Get subfield (equivalent to extract)	@example: date_part('minute', TIMESTAMP '1992-09-20 20:38:40')	@default: datepart(ts:VARCHAR[], col1:TIMESTAMP | TIME WITH TIME ZONE | TIMESTAMP WITH TIME ZONE | DATE | TIME | INTERVAL) -> STRUCT()*/
...
export interface DStructField<T = {}> {
  ...
  /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - [DStruct] - - - - - - -  */
  /**                                                            @description: Extract the indexth (1-based) value from the array.	@example: array_extract('DuckDB', 2)	@default: array_extract(list:STRUCT, index:VARCHAR | BIGINT) -> ANY*/
...
export interface _DJsonField<T = {}> {
  ...
  /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - [DJson] - - - - - - -  */
  /**                                                            @default: json_contains(col0:JSON, col1:VARCHAR | JSON) -> BOOLEAN*/
  ...
  /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - [DJson] - - - - - - -  */
  /**                                                            @default: json_extract(col0:JSON, col1:VARCHAR | BIGINT) -> JSON*/
  ...
  /**                                                            @default: json_extract_string(col0:JSON, col1:VARCHAR | BIGINT) -> VARCHAR*/
  ...
  /**                                                            @default: json_value(col0:JSON, col1:VARCHAR | BIGINT) -> VARCHAR*/
...
export interface DVarcharField extends DAnyField {
  ...
  regexp_extract_all(regex: DVarcharable, group0?: DAnyable | DNumericable, options?: DAnyable | DVarcharable): DArrayField<DVarcharField>;
  /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - [DVarchar] - - - - - - -  */
  ...
  regexp_matches(pattern: DVarcharable, options?: DAnyable | DVarcharable): DBoolField;
  /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - [DVarchar] - - - - - - -  */
  ...
  /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - [DVarchar] - - - - - - -  */
  /**                                                            @description: The number of complete partitions between the timestamps	@example: date_sub('hour', TIMESTAMPTZ '1992-09-30 23:59:59', TIMESTAMPTZ '1992-10-01 01:58:00')	@default: date_sub(part:VARCHAR, startdate:TIMESTAMP WITH TIME ZONE | DATE | TIME | TIMESTAMP, enddate:TIMESTAMP WITH TIME ZONE | DATE | TIME | TIMESTAMP) -> BIGINT*/
  date_sub(startdate: DDateable, enddate: DDateable): DNumericField;
  /**                                                            @description: The number of complete partitions between the timestamps	@example: date_sub('hour', TIMESTAMPTZ '1992-09-30 23:59:59', TIMESTAMPTZ '1992-10-01 01:58:00')	@default: datesub(part:VARCHAR, startdate:TIME | TIMESTAMP WITH TIME ZONE | TIMESTAMP | DATE, enddate:TIME | TIMESTAMP WITH TIME ZONE | TIMESTAMP | DATE) -> BIGINT*/
  ...
  regexp_full_match(regex: DVarcharable, options?: DAnyable | DVarcharable): DBoolField;
  /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - [DVarchar] - - - - - - -  */
  ...
  regexp_replace(pattern: DVarcharable, replacement: DVarcharable, options?: DAnyable | DVarcharable): DVarcharField;
  /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - [DVarchar] - - - - - - -  */
  ...
  /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - [DVarchar] - - - - - - -  */
  /**                                                            @description: Get subfield (equivalent to extract)	@example: date_part('minute', TIMESTAMP '1992-09-20 20:38:40')	@default: date_part(ts:VARCHAR, col1:TIME | TIMESTAMP | DATE | INTERVAL | TIME WITH TIME ZONE | TIMESTAMP WITH TIME ZONE) -> BIGINT*/
  date_part(col1: DAnyable | DDateable): DNumericField;
  /**                                                            @description: Get subfield (equivalent to extract)	@example: date_part('minute', TIMESTAMP '1992-09-20 20:38:40')	@default: datepart(ts:VARCHAR, col1:INTERVAL | DATE | TIME | TIMESTAMP | TIME WITH TIME ZONE | TIMESTAMP WITH TIME ZONE) -> BIGINT*/
  datepart: this["date_part"];
  /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - [DVarchar] - - - - - - -  */
  ...
  /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - [DVarchar] - - - - - - -  */
  /**                                                            @description: If string contains the regexp pattern, returns the capturing group specified by optional parameter group. The group must be a constant value. If no group is given, it defaults to 0. A set of optional options can be set.	@example: regexp_extract('abc', '([a-z])(b)', 1)	@default: regexp_extract(string:VARCHAR, pattern:VARCHAR, group0:VARCHAR[] | INTEGER | , options:VARCHAR | ) -> VARCHAR*/
  regexp_extract(pattern: DVarcharable, group0?: DAnyable | DArrayable | DNumericable, options?: DAnyable | DVarcharable): DVarcharField;
  /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - [DVarchar] - - - - - - -  */
  ...
  /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - [DVarchar] - - - - - - -  */
  /**                                                            @description: Converts a date to a string according to the format string.	@example: strftime(date '1992-01-01', '%a, %-d %B %Y')	@default: strftime(data:VARCHAR, format:TIMESTAMP_NS | DATE | TIMESTAMP) -> VARCHAR*/
...
export interface _DVarcharComp extends DAnyComp {
  ...
  /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - [DVarchar] - - - - - - -  */
  /**                                                            @description: If string contains the regexp pattern, replaces the matching part with replacement. A set of optional options can be set.	@example: regexp_replace('hello', '[lo]', '-')	@default: regexp_replace(string:VARCHAR, pattern:VARCHAR, replacement:VARCHAR, options:VARCHAR | ) -> VARCHAR*/
  regexp_replace(pattern: DVarcharable, replacement: DVarcharable, options?: DAnyable | DVarcharable): string & _DVarcharComp;
  /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - [DVarchar] - - - - - - -  */
  /**                                                            @description: The Jaro-Winkler similarity between two strings. Different case is considered different. Returns a number between 0 and 1	@example: jaro_winkler_similarity('duck', 'duckdb', 0.5)	@default: jaro_winkler_similarity(str1:VARCHAR, str2:VARCHAR, scoreCutoff:DOUBLE | ) -> DOUBLE*/
  ...
  /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - [DVarchar] - - - - - - -  */
  /**                                                            @description: If string contains the regexp pattern, returns the capturing group specified by optional parameter group. The group must be a constant value. If no group is given, it defaults to 0. A set of optional options can be set.	@example: regexp_extract('abc', '([a-z])(b)', 1)	@default: regexp_extract(string:VARCHAR, pattern:VARCHAR, group0:VARCHAR[] | INTEGER | , options:VARCHAR | ) -> VARCHAR*/
  regexp_extract(pattern: DVarcharable, group0?: DAnyable | DArrayable | DNumericable, options?: DAnyable | DVarcharable): string & _DVarcharComp;
  /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - [DVarchar] - - - - - - -  */
  /**                                                            @description: Return the following value of the sequence.	@example: nextval('my_sequence_name')	@default: nextval(sequenceName:VARCHAR) -> BIGINT*/
...
export interface DGlobal<DNum, DStr> extends DConstructors<DNum, DStr> {
  /**                                                            @description: Convert string to lower case	@example: lower('Hello')	@default: lcase(string:VARCHAR) -> VARCHAR*/
  ...
  /* … … … … … … … … … … … … … … … … … … … … … … … … … … … … … … [Global] … … … … … … …  */
  /**                                                            @description: Split the string along the regex and extract all occurrences of group. A set of optional options can be set.	@example: regexp_extract_all('hello_world', '([a-z ]+)_?', 1)	@default: regexp_extract_all(string:VARCHAR, regex:VARCHAR, group0:INTEGER | , options:VARCHAR | ) -> VARCHAR[]*/
  regexp_extract_all(string: DVarcharable, regex: DVarcharable, group0?: DAnyable | DNumericable, options?: DAnyable | DVarcharable): DArrayField<DVarcharField>;
  /* … … … … … … … … … … … … … … … … … … … … … … … … … … … … … … [Global] … … … … … … …  */
  /**                                                            @description: Computes the arctangent (y, x)	@example: atan2(1.0, 0.0)	@default: atan2(y:DOUBLE, x:DOUBLE) -> DOUBLE*/
  ...
  /* … … … … … … … … … … … … … … … … … … … … … … … … … … … … … … [Global] … … … … … … …  */
  /**                                                            @description: Returns true if string contains the regexp pattern, false otherwise. A set of optional options can be set.	@example: regexp_matches('anabanana', '(an)*')	@default: regexp_matches(string:VARCHAR, pattern:VARCHAR, options:VARCHAR | ) -> BOOLEAN*/
  regexp_matches(string: DVarcharable, pattern: DVarcharable, options?: DAnyable | DVarcharable): DBoolField;
  /* … … … … … … … … … … … … … … … … … … … … … … … … … … … … … … [Global] … … … … … … …  */
  /**                                                            @description: Convert string to upper case.	@example: upper('Hello')	@default: ucase(string:VARCHAR) -> VARCHAR*/
  ...
  current_query(): DStr;
  /* … … … … … … … … … … … … … … … … … … … … … … … … … … … … … … [Global] … … … … … … …  */
  /**                                                            @description: Internal only. Calculates the sum value for all tuples in arg without overflow checks.	@example: sum_no_overflow(A)	@default: sum_no_overflow(arg:INTEGER | DECIMAL | BIGINT) -> HUGEINT*/
  sum_no_overflow(arg: DNumericable): DNum;
  /* … … … … … … … … … … … … … … … … … … … … … … … … … … … … … … [Global] … … … … … … …  */
  /**                                                            @description: Returns true if the entire string matches the regex. A set of optional options can be set.	@example: regexp_full_match('anabanana', '(an)*')	@default: regexp_full_match(string:VARCHAR, regex:VARCHAR, options:VARCHAR | ) -> BOOLEAN*/
  regexp_full_match(string: DVarcharable, regex: DVarcharable, options?: DAnyable | DVarcharable): DBoolField;
  /* … … … … … … … … … … … … … … … … … … … … … … … … … … … … … … [Global] … … … … … … …  */
  /**                                                            @description: Returns a string with statistics about the expression. Expression can be a column, constant, or SQL expression	@example: stats(5)	@default: stats(expression:ANY) -> VARCHAR*/
  ...
  /* … … … … … … … … … … … … … … … … … … … … … … … … … … … … … … [Global] … … … … … … …  */
  /**                                                            @description: Calculates the average value for all tuples in x.	@example: SUM(x) / COUNT(*)	@default: mean(x:DECIMAL | SMALLINT | INTEGER | BIGINT | HUGEINT | DOUBLE) -> DECIMAL*/
  mean(x: DNumericable): DNum;
  /**                                                            @description: Calculates the average value for all tuples in x.	@example: SUM(x) / COUNT(*)	@default: avg(x:DOUBLE | HUGEINT | BIGINT | INTEGER | SMALLINT | DECIMAL) -> DOUBLE*/
  avg: this["mean"];
  /* … … … … … … … … … … … … … … … … … … … … … … … … … … … … … … [Global] … … … … … … …  */
  /**                                                            @description: Splits the string along the separator	@example: string_split('hello-world', '-')	@default: string_to_array(string:VARCHAR, separator:VARCHAR) -> VARCHAR[]*/
  ...
  /* … … … … … … … … … … … … … … … … … … … … … … … … … … … … … … [Global] … … … … … … …  */
  /**                                                            @description: If string contains the regexp pattern, replaces the matching part with replacement. A set of optional options can be set.	@example: regexp_replace('hello', '[lo]', '-')	@default: regexp_replace(string:VARCHAR, pattern:VARCHAR, replacement:VARCHAR, options:VARCHAR | ) -> VARCHAR*/
  regexp_replace(string: DVarcharable, pattern: DVarcharable, replacement: DVarcharable, options?: DAnyable | DVarcharable): DStr;
  /* … … … … … … … … … … … … … … … … … … … … … … … … … … … … … … [Global] … … … … … … …  */
  /**                                                            @description: Converts bytes to a human-readable presentation (e.g. 16000 -> 15.6 KiB)	@example: format_bytes(1000 * 16)	@default: formatReadableSize(bytes:BIGINT) -> VARCHAR*/
  ...
  /* … … … … … … … … … … … … … … … … … … … … … … … … … … … … … … [Global] … … … … … … …  */
  /**                                                            @description: Calculates the sum value for all tuples in arg.	@example: sum(A)	@default: sum(arg:DOUBLE | DECIMAL | BOOLEAN | SMALLINT | INTEGER | BIGINT | HUGEINT) -> DOUBLE*/
  ...
  /* … … … … … … … … … … … … … … … … … … … … … … … … … … … … … … [Global] … … … … … … …  */
  /**                                                            @description: If string contains the regexp pattern, returns the capturing group specified by optional parameter group. The group must be a constant value. If no group is given, it defaults to 0. A set of optional options can be set.	@example: regexp_extract('abc', '([a-z])(b)', 1)	@default: regexp_extract(string:VARCHAR, pattern:VARCHAR, group0:VARCHAR[] | INTEGER | , options:VARCHAR | ) -> VARCHAR*/
  regexp_extract(string: DVarcharable, pattern: DVarcharable, group0?: DAnyable | DArrayable | DNumericable, options?: DAnyable | DVarcharable): DStr;
  /* … … … … … … … … … … … … … … … … … … … … … … … … … … … … … … [Global] … … … … … … …  */
  /**                                                            @description: Compute the negative inner product between two lists	@example: list_negative_inner_product([1, 2, 3], [1, 2, 3])	@default: list_negative_inner_product(list1:DOUBLE[], list2:DOUBLE[]) -> DOUBLE*/
  ...
  /**                                                            @default: add(col0:INTERVAL, col1:TIME WITH TIME ZONE | TIMESTAMP | TIME | DATE) -> TIME WITH TIME ZONE*/
  ...
  /**                                                            @description: Computes the approximate quantile using T-Digest.	@example: approx_quantile(x, 0.5)	@default: approx_quantile(x:TIMESTAMP | DATE | TIME WITH TIME ZONE | TIME | DECIMAL | TINYINT | SMALLINT | INTEGER | BIGINT | HUGEINT | FLOAT | DOUBLE | TIMESTAMP WITH TIME ZONE, pos:FLOAT[]) -> TIMESTAMP[]*/
  approx_quantile(x: DDateable | DNumericable, pos: DArrayable): DArrayField<DDateField>;
  /**                                                            @description: Computes the approximate quantile using T-Digest.	@example: approx_quantile(x, 0.5)	@default: approx_quantile(x:DECIMAL | SMALLINT | INTEGER | BIGINT | HUGEINT | DOUBLE, pos:FLOAT) -> DECIMAL*/
  ...
  /* … … … … … … … … … … … … … … … … … … … … … … … … … … … … … … [Global] … … … … … … …  */
  /**                                                            @description: Finds the row with the maximum val. Calculates the non-NULL arg expression at that row.	@example: arg_max(A,B)	@default: arg_max(arg:DATE | TIMESTAMP WITH TIME ZONE | TIMESTAMP, val:BLOB | TIMESTAMP | TIMESTAMP WITH TIME ZONE | DATE | VARCHAR | DOUBLE | HUGEINT | BIGINT | INTEGER) -> DATE*/
  arg_max(arg: DDateable, val: DAnyable | DDateable | DNumericable | DVarcharable): DDateField;
  /**                                                            @description: Finds the row with the maximum val. Calculates the non-NULL arg expression at that row.	@example: arg_max(A,B)	@default: arg_max(arg:BLOB | ANY, val:TIMESTAMP WITH TIME ZONE | BLOB | INTEGER | BIGINT | HUGEINT | DOUBLE | VARCHAR | DATE | TIMESTAMP | ANY) -> BLOB*/
  ...
  /**                                                            @description: Finds the row with the maximum val. Calculates the non-NULL arg expression at that row.	@example: arg_max(A,B)	@default: arg_max(arg:DECIMAL | INTEGER | BIGINT | DOUBLE, val:INTEGER | BIGINT | HUGEINT | DOUBLE | VARCHAR | DATE | TIMESTAMP | TIMESTAMP WITH TIME ZONE | BLOB) -> DECIMAL*/
  arg_max(arg: DNumericable, val: DAnyable | DDateable | DNumericable | DVarcharable): DNum;
  /**                                                            @description: Finds the row with the maximum val. Calculates the non-NULL arg expression at that row.	@example: arg_max(A,B)	@default: arg_max(arg:VARCHAR, val:HUGEINT | DOUBLE | INTEGER | BIGINT | BLOB | TIMESTAMP WITH TIME ZONE | TIMESTAMP | DATE | VARCHAR) -> VARCHAR*/
  arg_max(arg: DVarcharable, val: DAnyable | DDateable | DNumericable | DVarcharable): DStr;
  /**                                                            @description: Finds the row with the maximum val. Calculates the non-NULL arg expression at that row.	@example: arg_max(A,B)	@default: argmax(arg:DATE | TIMESTAMP | TIMESTAMP WITH TIME ZONE, val:INTEGER | BIGINT | HUGEINT | DOUBLE | VARCHAR | DATE | TIMESTAMP | TIMESTAMP WITH TIME ZONE | BLOB) -> DATE*/
  argmax: this["arg_max"];
  /**                                                            @description: Finds the row with the maximum val. Calculates the non-NULL arg expression at that row.	@example: arg_max(A,B)	@default: max_by(arg:DATE | TIMESTAMP WITH TIME ZONE | TIMESTAMP, val:BIGINT | BLOB | TIMESTAMP WITH TIME ZONE | TIMESTAMP | DATE | VARCHAR | DOUBLE | HUGEINT | INTEGER) -> DATE*/
  max_by: this["arg_max"];
  /* … … … … … … … … … … … … … … … … … … … … … … … … … … … … … … [Global] … … … … … … …  */
  /**                                                            @description: Finds the row with the maximum val. Calculates the arg expression at that row.	@example: arg_max_null(A,B)	@default: arg_max_null(arg:TIMESTAMP WITH TIME ZONE | TIMESTAMP | DATE, val:TIMESTAMP | INTEGER | BLOB | TIMESTAMP WITH TIME ZONE | DATE | VARCHAR | DOUBLE | HUGEINT | BIGINT) -> TIMESTAMP WITH TIME ZONE*/
  arg_max_null(arg: DDateable, val: DAnyable | DDateable | DNumericable | DVarcharable): DDateField;
  /**                                                            @description: Finds the row with the maximum val. Calculates the arg expression at that row.	@example: arg_max_null(A,B)	@default: arg_max_null(arg:ANY | BLOB, val:BIGINT | INTEGER | HUGEINT | DOUBLE | VARCHAR | DATE | TIMESTAMP | TIMESTAMP WITH TIME ZONE | BLOB | ANY) -> ANY*/
  arg_max_null(arg: DAnyable, val: DAnyable | DDateable | DNumericable | DVarcharable): DAnyField;
  /**                                                            @description: Finds the row with the maximum val. Calculates the arg expression at that row.	@example: arg_max_null(A,B)	@default: arg_max_null(arg:INTEGER | DOUBLE | BIGINT | DECIMAL, val:HUGEINT | BLOB | TIMESTAMP WITH TIME ZONE | TIMESTAMP | DATE | VARCHAR | DOUBLE | BIGINT | INTEGER) -> INTEGER*/
  arg_max_null(arg: DNumericable, val: DAnyable | DDateable | DNumericable | DVarcharable): DNum;
  /**                                                            @description: Finds the row with the maximum val. Calculates the arg expression at that row.	@example: arg_max_null(A,B)	@default: arg_max_null(arg:VARCHAR, val:BLOB | TIMESTAMP WITH TIME ZONE | TIMESTAMP | DATE | VARCHAR | DOUBLE | HUGEINT | BIGINT | INTEGER) -> VARCHAR*/
  arg_max_null(arg: DVarcharable, val: DAnyable | DDateable | DNumericable | DVarcharable): DStr;
  /* … … … … … … … … … … … … … … … … … … … … … … … … … … … … … … [Global] … … … … … … …  */
  /**                                                            @description: Finds the row with the minimum val. Calculates the non-NULL arg expression at that row.	@example: arg_min(A,B)	@default: arg_min(arg:TIMESTAMP | DATE | TIMESTAMP WITH TIME ZONE, val:DATE | TIMESTAMP WITH TIME ZONE | INTEGER | BIGINT | HUGEINT | DOUBLE | VARCHAR | TIMESTAMP | BLOB) -> TIMESTAMP*/
  arg_min(arg: DDateable, val: DAnyable | DDateable | DNumericable | DVarcharable): DDateField;
  /**                                                            @description: Finds the row with the minimum val. Calculates the non-NULL arg expression at that row.	@example: arg_min(A,B)	@default: arg_min(arg:BLOB | ANY, val:INTEGER | BIGINT | HUGEINT | DOUBLE | VARCHAR | DATE | TIMESTAMP | TIMESTAMP WITH TIME ZONE | BLOB | ANY) -> BLOB*/
  ...
  /**                                                            @description: Finds the row with the minimum val. Calculates the non-NULL arg expression at that row.	@example: arg_min(A,B)	@default: arg_min(arg:INTEGER | BIGINT | DOUBLE | DECIMAL, val:VARCHAR | BIGINT | BLOB | INTEGER | HUGEINT | DOUBLE | DATE | TIMESTAMP | TIMESTAMP WITH TIME ZONE) -> INTEGER*/
  arg_min(arg: DNumericable, val: DAnyable | DDateable | DNumericable | DVarcharable): DNum;
  /**                                                            @description: Finds the row with the minimum val. Calculates the non-NULL arg expression at that row.	@example: arg_min(A,B)	@default: arg_min(arg:VARCHAR, val:INTEGER | BIGINT | HUGEINT | DOUBLE | VARCHAR | DATE | TIMESTAMP | TIMESTAMP WITH TIME ZONE | BLOB) -> VARCHAR*/
  arg_min(arg: DVarcharable, val: DAnyable | DDateable | DNumericable | DVarcharable): DStr;
  /**                                                            @description: Finds the row with the minimum val. Calculates the non-NULL arg expression at that row.	@example: arg_min(A,B)	@default: argmin(arg:TIMESTAMP | DATE | TIMESTAMP WITH TIME ZONE, val:DOUBLE | DATE | INTEGER | BIGINT | HUGEINT | VARCHAR | TIMESTAMP | TIMESTAMP WITH TIME ZONE | BLOB) -> TIMESTAMP*/
  argmin: this["arg_min"];
  /**                                                            @description: Finds the row with the minimum val. Calculates the non-NULL arg expression at that row.	@example: arg_min(A,B)	@default: min_by(arg:DATE | TIMESTAMP | TIMESTAMP WITH TIME ZONE, val:BLOB | INTEGER | BIGINT | HUGEINT | DOUBLE | VARCHAR | DATE | TIMESTAMP | TIMESTAMP WITH TIME ZONE) -> DATE*/
  min_by: this["arg_min"];
  /* … … … … … … … … … … … … … … … … … … … … … … … … … … … … … … [Global] … … … … … … …  */
  /**                                                            @description: Finds the row with the minimum val. Calculates the arg expression at that row.	@example: arg_min_null(A,B)	@default: arg_min_null(arg:DATE | TIMESTAMP | TIMESTAMP WITH TIME ZONE, val:INTEGER | BIGINT | HUGEINT | DOUBLE | VARCHAR | DATE | TIMESTAMP | TIMESTAMP WITH TIME ZONE | BLOB) -> DATE*/
  arg_min_null(arg: DDateable, val: DAnyable | DDateable | DNumericable | DVarcharable): DDateField;
  /**                                                            @description: Finds the row with the minimum val. Calculates the arg expression at that row.	@example: arg_min_null(A,B)	@default: arg_min_null(arg:BLOB | ANY, val:INTEGER | BIGINT | HUGEINT | DOUBLE | VARCHAR | DATE | TIMESTAMP | TIMESTAMP WITH TIME ZONE | BLOB | ANY) -> BLOB*/
  arg_min_null(arg: DAnyable, val: DAnyable | DDateable | DNumericable | DVarcharable): DAnyField;
  /**                                                            @description: Finds the row with the minimum val. Calculates the arg expression at that row.	@example: arg_min_null(A,B)	@default: arg_min_null(arg:INTEGER | DECIMAL | BIGINT | DOUBLE, val:BIGINT | TIMESTAMP | TIMESTAMP WITH TIME ZONE | BLOB | INTEGER | HUGEINT | DOUBLE | VARCHAR | DATE) -> INTEGER*/
  arg_min_null(arg: DNumericable, val: DAnyable | DDateable | DNumericable | DVarcharable): DNum;
  /**                                                            @description: Finds the row with the minimum val. Calculates the arg expression at that row.	@example: arg_min_null(A,B)	@default: arg_min_null(arg:VARCHAR, val:BIGINT | HUGEINT | DOUBLE | VARCHAR | DATE | TIMESTAMP | TIMESTAMP WITH TIME ZONE | BLOB | INTEGER) -> VARCHAR*/
  ...
  /**                                                            @description: Returns the bitwise AND of all bits in a given expression.	@example: bit_and(A)	@default: bit_and(arg:UINTEGER | TINYINT | USMALLINT | UHUGEINT | UBIGINT | UTINYINT | HUGEINT | BIGINT | INTEGER | SMALLINT) -> UINTEGER*/
  ...
  /**                                                            @description: Returns the bitwise OR of all bits in a given expression.	@example: bit_or(A)	@default: bit_or(arg:SMALLINT | TINYINT | BIGINT | HUGEINT | UTINYINT | USMALLINT | UINTEGER | INTEGER | UBIGINT | UHUGEINT) -> SMALLINT*/
  ...
  /**                                                            @description: Returns the bitwise XOR of all bits in a given expression.	@example: bit_xor(A)	@default: bit_xor(arg:TINYINT | SMALLINT | BIGINT | HUGEINT | UTINYINT | USMALLINT | UINTEGER | UBIGINT | UHUGEINT | INTEGER) -> TINYINT*/
  ...
  /**                                                            @description: Truncate to specified precision	@example: date_trunc('hour', TIMESTAMPTZ '1992-09-20 20:38:40')	@default: datetrunc(part:VARCHAR, timestamp:TIMESTAMP WITH TIME ZONE | TIMESTAMP | DATE) -> TIMESTAMP WITH TIME ZONE*/
  ...
  /**                                                            @default: json_contains(col0:VARCHAR, col1:VARCHAR | JSON) -> BOOLEAN*/
  ...
  /**                                                            @default: json_extract_path(col0:VARCHAR, col1:VARCHAR | BIGINT) -> JSON*/
  ...
  /**                                                            @default: json_value(col0:VARCHAR, col1:VARCHAR | BIGINT) -> VARCHAR*/
  ...
  list_extract: this["list_element"];
  /* … … … … … … … … … … … … … … … … … … … … … … … … … … … … … … [Global] … … … … … … …  */
  /**                                                            @description: Returns the median absolute deviation for the values within x. NULL values are ignored. Temporal types return a positive INTERVAL.		@example: mad(x)	@default: mad(x:TIMESTAMP WITH TIME ZONE | TIME | TIME WITH TIME ZONE | TIMESTAMP | DATE) -> INTERVAL*/
  mad(x: DDateable): DAnyField;
  /**                                                            @description: Returns the median absolute deviation for the values within x. NULL values are ignored. Temporal types return a positive INTERVAL.		@example: mad(x)	@default: mad(x:DOUBLE | FLOAT | DECIMAL) -> DOUBLE*/
  ...
  /* … … … … … … … … … … … … … … … … … … … … … … … … … … … … … … [Global] … … … … … … …  */
  /**                                                            @description: Gives the approximate quantile using reservoir sampling, the sample size is optional and uses 8192 as a default size.	@example: reservoir_quantile(A,0.5,1024)	@default: reservoir_quantile(x:FLOAT | DOUBLE | TINYINT | SMALLINT | BIGINT | HUGEINT | INTEGER | DECIMAL, quantile:DOUBLE[], sampleSize: | INTEGER) -> TINYINT[]*/
  reservoir_quantile(x: DNumericable, quantile: DArrayable, sampleSize?: DAnyable | DNumericable): DArrayField<DNumericField>;
  /**                                                            @description: Gives the approximate quantile using reservoir sampling, the sample size is optional and uses 8192 as a default size.	@example: reservoir_quantile(A,0.5,1024)	@default: reservoir_quantile(x:BIGINT | DOUBLE | TINYINT | SMALLINT | INTEGER | HUGEINT | FLOAT | DECIMAL, quantile:DOUBLE, sampleSize:INTEGER | ) -> BIGINT*/
...
export type DGlobalField = DGlobal<DNumericField, DVarcharField> & DConstructors<DNumericField, DVarcharField>;

export type DGlobalComp = DGlobal<DNumericComp, DVarcharComp> & DConstructors<DNumericComp, DVarcharComp>;
