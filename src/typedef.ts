...
export type DPrimitiveField = t.DVarcharField | t.DNumericField | t.DOtherField | t.DDateField | t.DBoolField
export type DNestedField = t.DArrayField | t.DStructField | t.DJsonField
export type DField = DPrimitiveField | DNestedField | DRawField
