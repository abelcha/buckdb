...
type ReadCsvOptions = {
  ...
  files_to_sniff?: number; // Corresponds to files_to_sniff
  ...
  thousands?: string; // Corresponds to thousands
...
type ReadParquetOptions = {
  ...
  can_have_nan?: boolean; // Corresponds to can_have_nan (BOOL)
...
type Fnx = {
  read_csv<const F extends string>(
    args: F
  ): RetCon<"read_csv", CsvKeys, [F], {}>;
  read_csv<const F extends readonly string[]>(
    ...args: F[]
  ): RetCon<"read_csv", CsvKeys, F, {}>;
  read_csv<const F extends string[], const U extends ReadCsvOptions>(
    ...args: [...F, U]
  ): RetCon<"read_csv", CsvKeys, F, U>;
  read_csv<const F extends readonly string[], const U extends ReadCsvOptions>(
    ...args: [...F[], U]
  ): RetCon<"read_csv", CsvKeys, F, U>;
  read_json<const F extends string>(
    args: F
  ): RetCon<"read_json", JsonReadKeys, [F], {}>;
  read_json<const F extends readonly string[]>(
    ...args: F[]
  ): RetCon<"read_json", JsonReadKeys, F, {}>;
  read_json<const F extends string[], const U extends ReadJsonOptions>(
    ...args: [...F, U]
  ): RetCon<"read_json", JsonReadKeys, F, U>;
  read_json<const F extends readonly string[], const U extends ReadJsonOptions>(
    ...args: [...F[], U]
  ): RetCon<"read_json", JsonReadKeys, F, U>;
  read_json_objects<const F extends string>(
    args: F
  ): RetCon<"read_json_objects", JsonReadObjectsKeys, [F], {}>;
  read_json_objects<const F extends readonly string[]>(
    ...args: F[]
  ): RetCon<"read_json_objects", JsonReadObjectsKeys, F, {}>;
  read_json_objects<
    const F extends string[],
    const U extends ReadJsonObjectsOptions
  >(
    ...args: [...F, U]
  ): RetCon<"read_json_objects", JsonReadObjectsKeys, F, U>;
  read_json_objects<
  ...
  read_parquet<const F extends string>(
    args: F
  ): RetCon<"read_parquet", ParquetKeys, [F], {}>;
  read_parquet<const F extends readonly string[]>(
    ...args: F[]
  ): RetCon<"read_parquet", ParquetKeys, F, {}>;
  read_parquet<const F extends string[], const U extends ReadParquetOptions>(
    ...args: [...F, U]
  ): RetCon<"read_parquet", ParquetKeys, F, U>;
  read_parquet<
    const F extends readonly string[],
    const U extends ReadParquetOptions
  >(
    ...args: [...F[], U]
  ): RetCon<"read_parquet", ParquetKeys, F, U>;
  delta_scan<const F extends string>(
    args: F
  ): RetCon<"delta_scan", DeltaScanKeys, [F], {}>;
  delta_scan<const F extends readonly string[]>(
    ...args: F[]
  ): RetCon<"delta_scan", DeltaScanKeys, F, {}>;
  delta_scan<const F extends string[], const U extends DeltaScanOptions>(
    ...args: [...F, U]
  ): RetCon<"delta_scan", DeltaScanKeys, F, U>;
  delta_scan<
    const F extends readonly string[],
    const U extends DeltaScanOptions
  >(
    ...args: [...F[], U]
  ): RetCon<"delta_scan", DeltaScanKeys, F, U>;
  parquet_scan<const F extends string>(
    args: F
  ): RetCon<"parquet_scan", ParquetKeys, [F], {}>;
  parquet_scan<const F extends readonly string[]>(
    ...args: F[]
  ): RetCon<"parquet_scan", ParquetKeys, F, {}>;
  parquet_scan<const F extends string[], const U extends ReadParquetOptions>(
    ...args: [...F, U]
  ): RetCon<"parquet_scan", ParquetKeys, F, U>;
  parquet_scan<
    const F extends readonly string[],
    const U extends ReadParquetOptions
  >(
  ...
  read_xlsx<const F extends string>(
    args: F
  ): RetCon<"read_xlsx", ReadXlsxKeys, [F], {}>;
  read_xlsx<const F extends readonly string[]>(
    ...args: F[]
  ): RetCon<"read_xlsx", ReadXlsxKeys, F, {}>;
  read_xlsx<const F extends string[], const U extends ReadXlsxOptions>(
    ...args: [...F, U]
  ): RetCon<"read_xlsx", ReadXlsxKeys, F, U>;
  read_xlsx<const F extends readonly string[], const U extends ReadXlsxOptions>(
    ...args: [...F[], U]
  ): RetCon<"read_xlsx", ReadXlsxKeys, F, U>;
  read_text<const F extends string>(args: F): RetCon<"read_text", [], [F], {}>;
  read_text<const F extends readonly string[]>(
    ...args: F[]
  ): RetCon<"read_text", [], F, {}>;
  read_text<const F extends string[]>(
    ...args: [...F, {}]
  ): RetCon<"read_text", [], F, {}>;
  read_text<const F extends readonly string[]>(
    ...args: [...F[], {}]
  ): RetCon<"read_text", [], F, {}>;
  iceberg_metadata<const F extends string>(
    args: F
  ): RetCon<"iceberg_metadata", IcebergMetadataKeys, [F], {}>;
  iceberg_metadata<const F extends readonly string[]>(
    ...args: F[]
  ): RetCon<"iceberg_metadata", IcebergMetadataKeys, F, {}>;
  iceberg_metadata<
    const F extends string[],
    const U extends IcebergMetadataOptions
  >(
    ...args: [...F, U]
  ): RetCon<"iceberg_metadata", IcebergMetadataKeys, F, U>;
  iceberg_metadata<
    const F extends readonly string[],
    const U extends IcebergMetadataOptions
  >(
  ...
  iceberg_scan<const F extends string>(
    args: F
  ): RetCon<"iceberg_scan", IcebergScanKeys, [F], {}>;
  iceberg_scan<const F extends readonly string[]>(
    ...args: F[]
  ): RetCon<"iceberg_scan", IcebergScanKeys, F, {}>;
  iceberg_scan<const F extends string[], const U extends IcebergScanOptions>(
    ...args: [...F, U]
  ): RetCon<"iceberg_scan", IcebergScanKeys, F, U>;
  iceberg_scan<
    const F extends readonly string[],
    const U extends IcebergScanOptions
  >(
    ...args: [...F[], U]
  ): RetCon<"iceberg_scan", IcebergScanKeys, F, U>;
  iceberg_snapshots<const F extends string>(
    args: F
  ): RetCon<"iceberg_snapshots", IcebergSnapshotsKeys, [F], {}>;
  iceberg_snapshots<const F extends readonly string[]>(
    ...args: F[]
  ): RetCon<"iceberg_snapshots", IcebergSnapshotsKeys, F, {}>;
  iceberg_snapshots<
    const F extends string[],
    const U extends IcebergSnapshotsOptions
  >(
    ...args: [...F, U]
  ): RetCon<"iceberg_snapshots", IcebergSnapshotsKeys, F, U>;
  iceberg_snapshots<
    const F extends readonly string[],
    const U extends IcebergSnapshotsOptions
  >(
  ...
  ST_Read<const F extends string>(
    args: F
  ): RetCon<"ST_Read", STReadKeys, [F], {}>;
  ST_Read<const F extends readonly string[]>(
    ...args: F[]
  ): RetCon<"ST_Read", STReadKeys, F, {}>;
  ST_Read<const F extends string[], const U extends STReadOptions>(
    ...args: [...F, U]
  ): RetCon<"ST_Read", STReadKeys, F, U>;
  ST_Read<const F extends readonly string[], const U extends STReadOptions>(
    ...args: [...F[], U]
  ): RetCon<"ST_Read", STReadKeys, F, U>;
  ST_Read_Meta<const F extends string>(
    args: F
  ): RetCon<"ST_Read_Meta", [], [F], {}>;
  ST_Read_Meta<const F extends readonly string[]>(
    ...args: F[]
  ): RetCon<"ST_Read_Meta", [], F, {}>;
  ST_ReadOsm<const F extends string>(
    args: F
  ): RetCon<"ST_ReadOsm", [], [F], {}>;
  ST_ReadOsm<const F extends readonly string[]>(
    ...args: F[]
  ): RetCon<"ST_ReadOsm", [], F, {}>;
  ST_ReadSHP<const F extends string>(
    args: F
  ): RetCon<"ST_ReadSHP", STReadSHPKeys, [F], {}>;
  ST_ReadSHP<const F extends readonly string[]>(
    ...args: F[]
  ): RetCon<"ST_ReadSHP", STReadSHPKeys, F, {}>;
  ST_ReadSHP<const F extends string[], const U extends STReadSHPOptions>(
    ...args: [...F, U]
  ): RetCon<"ST_ReadSHP", STReadSHPKeys, F, U>;
  ST_ReadSHP<
    const F extends readonly string[],
    const U extends STReadSHPOptions
  >(
    ...args: [...F[], U]
  ): RetCon<"ST_ReadSHP", STReadSHPKeys, F, U>;
  read_sheet<const F extends string>(
    args: F
  ): RetCon<"read_sheet", ReadSheetKeys, [F], {}>;
  read_sheet<const F extends string[], const U extends ReadSheetOptions>(
    ...args: [...F, U]
  ): RetCon<"read_sheet", ReadSheetKeys, F, U>;
  read_sheets<const F extends readonly string[]>(
    ...args: F[]
  ): RetCon<"read_sheets", ReadSheetsKeys, F, {}>;
  read_sheets<
    const F extends readonly string[],
    const U extends ReadSheetsOptions
  >(
    ...args: [...F[], U]
  ): RetCon<"read_sheets", ReadSheetsKeys, F, U>;
  analyze_sheet<const F extends string>(
    args: F
  ): RetCon<"analyze_sheet", AnalyzeSheetKeys, [F], {}>;
  analyze_sheet<const F extends string[], const U extends AnalyzeSheetOptions>(
    ...args: [...F, U]
  ): RetCon<"analyze_sheet", AnalyzeSheetKeys, F, U>;
  analyze_sheets<const F extends readonly string[]>(
    ...args: F[]
  ): RetCon<"analyze_sheets", AnalyzeSheetsKeys, F, {}>;
  analyze_sheets<
    const F extends readonly string[],
    const U extends AnalyzeSheetsOptions
  >(
    ...args: [...F[], U]
  ): RetCon<"analyze_sheets", AnalyzeSheetsKeys, F, U>;
};
...
const fnSerial = (name = "", args: any[]) => {
  ...
  let source =
    name.match(/read_sheet|st_read|read_xlsx/i) && args.length === 1
      ? `"${args[0]}"`
      : `[${args.map((e = "") => `'${e}'`)}]`;
